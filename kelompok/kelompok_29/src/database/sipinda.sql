...
CREATE TABLE IF NOT EXISTS `sipinda`.`complaints` (
  ...
  `status` ENUM('diajukan', 'diverifikasi_admin', 'ditugaskan_ke_petugas', 'dalam_proses', 'menunggu_validasi_admin', 'selesai', 'ditolak_admin') NOT NULL DEFAULT 'diajukan',
...
CREATE TABLE IF NOT EXISTS `sipinda`.`complaint_progress` (
  ...
  `status` ENUM('diajukan', 'diverifikasi_admin', 'ditugaskan_ke_petugas', 'dalam_proses', 'menunggu_validasi_admin', 'selesai', 'ditolak_admin') NOT NULL,
